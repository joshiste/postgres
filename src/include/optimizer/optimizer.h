...
extern Bitmapset *pull_raw_reader_attrs(Node *node, Index varno, Bitmapset *attrs);
extern Bitmapset *pull_passthrough_attrs(Node *expr, Index varno, Bitmapset *attrs);
